...
export default function ExtendedActionPage() {
  const COL = 4, ROW = 2
  ...
  const { allPagesData, isLoading, totalPages } = useExtendedActions({
    size: COL * ROW,
        ...
        >
          <View style={styles.headerContent}>
            ...
            <View style={styles.headerTextContainer}>
              <Text style={styles.headerTitle}>Kỹ năng mở rộng</Text>
              <Text style={styles.headerSubtitle}>Chọn kỹ năng mở rộng cho AlphaMini</Text>
            </View>
          </View>
        </LinearGradient>
      </View>
